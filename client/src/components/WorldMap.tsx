      ...
      <div className="flex flex-col md:flex-row gap-8 items-center h-[280px]">
        ...
        <div className="flex-1 w-full bg-dark/30 rounded-3xl border border-gray-800/50 flex items-center justify-center relative group">
          <svg
            ...
            className="w-full h-full p-4 opacity-40 group-hover:opacity-60 transition-opacity"
          >
            <title>XAuth Global Activation Map</title>
            {/* Very simplified world outline for visual effect */}

            <path
              d="M150,150 L250,150 L300,200 L250,300 L150,250 Z"
              fill="currentColor"
              className="text-gray-600"
            />
            <path
              d="M400,100 L550,80 L650,120 L700,300 L550,350 L450,250 Z"
              fill="currentColor"
              className="text-gray-600"
            />
            <path
              d="M200,350 L350,380 L380,480 L250,450 Z"
              fill="currentColor"
              className="text-gray-600"
            />
            <path
              d="M750,150 L850,120 L900,250 L800,350 Z"
              fill="currentColor"
              className="text-gray-600"
            />
        ...
        <div className="w-full md:w-48 space-y-4">
          ...
          {topCountries.length === 0 && (
            <div className="text-center py-10 text-xs text-gray-600 font-bold italic">
              Gathering geo-data...
            </div>
          )}
        </div>
