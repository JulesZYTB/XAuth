...
export default function GenerateLicenseModal({
  ...
  const DURATION_OPTIONS = [
    ...
    {
      label: t("time.lifetime", "Lifetime"),
      value: 3650 * 24 * 60 * 60 * 1000,
    },
  ];

  const PATTERN_OPTIONS = [
    {
      label: t("licenses.pattern_standard", "Standard (XXXX-XXXX-XXXX)"),
      pattern: "XXXX-XXXX-XXXX",
    },
    {
      label: t("licenses.pattern_extended", "Extended (XXXXX-XXXXX-XXXXX)"),
      pattern: "XXXXX-XXXXX-XXXXX",
    },
    {
      label: t("licenses.pattern_legacy", "Legacy (XXXX-XXXX)"),
      pattern: "XXXX-XXXX",
    },
  ];
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={t("licenses.forge_title", "Advanced License Forge")}
    >
      <div className="space-y-8">
        ...
        <div className="space-y-3">
          ...
          >
            ...
            {t("licenses.key_format", "Key Format Architecture")}
          </label>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            {t("licenses.temporal_validity", "Temporal Validity")}
          </label>
        ...
        <div className="relative group">
          ...
          <input
            ...
            type="text"
            placeholder={t(
              "licenses.leave_blank_auto",
              "LEAVE BLANK FOR AUTO-GEN",
            )}
        ...
        >
          ...
          {t("licenses.init_prod", "Initialize Production")}
        </button>
      </div>
    </Modal>
  );
