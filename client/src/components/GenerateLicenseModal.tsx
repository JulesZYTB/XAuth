...
const DURATION_OPTIONS = [
  ...
  { label: "Lifetime", value: 3650 * 24 * 60 * 60 * 1000 },
];

const PATTERN_OPTIONS = [
  { label: "Standard (XXXX-XXXX-XXXX)", pattern: "XXXX-XXXX-XXXX" },
  { label: "Extended (XXXXX-XXXXX-XXXXX)", pattern: "XXXXX-XXXXX-XXXXX" },
  { label: "Legacy (XXXX-XXXX)", pattern: "XXXX-XXXX" },
];
...
export default function GenerateLicenseModal({ isOpen, onClose, onGenerate }: GenerateLicenseModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Advanced License Forge">
      <div className="space-y-8">
        ...
        <div className="space-y-3">
          ...
          >
            <Hash className="w-3 h-3" /> Key Format Architecture
          </label>
        ...
        <div className="space-y-3">
          <label 
            ...
            className="text-[10px] text-gray-500 uppercase font-black px-1 flex items-center gap-2"
          >
            <Clock className="w-3 h-3" /> Temporal Validity
          </label>
