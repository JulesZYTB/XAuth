...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-dark text-white font-sans selection:bg-accent selection:text-white relative overflow-x-hidden">
      ...
      <nav className="border-b border-gray-800/50 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xl font-black tracking-tighter">
              XAuth{" "}
              <span className="text-accent text-[10px] uppercase font-black tracking-widest ml-1 hidden sm:inline">
                Omega
              </span>
            </span>
          </div>
        ...
        {/* Mobile Menu Panel */}
        <div
          className={`md:hidden absolute top-20 left-0 w-full bg-secondary/95 backdrop-blur-xl border-b border-gray-800 transition-all duration-300 origin-top ${isMenuOpen ? "scale-y-100 opacity-100" : "scale-y-0 opacity-0 pointer-events-none"}`}
        >
          <div className="p-6 flex flex-col gap-4">
            <button
              onClick={() => navigate("/login")}
              className="w-full py-4 text-sm font-bold text-left text-gray-400 hover:text-white border-b border-gray-800/50 uppercase tracking-widest"
            >
              {t("home.login")}
            </button>
            <button
              onClick={() => navigate("/register")}
              className="w-full py-6 bg-accent text-white rounded-2xl font-black uppercase tracking-widest flex items-center justify-center gap-3"
            >
      ...
      {/* Hero Section */}
      <main className="max-w-7xl mx-auto px-6 pt-20 md:pt-32 pb-16 md:pb-20 text-center animate-in fade-in slide-in-from-bottom-8 duration-1000 overflow-x-hidden">
        ...
        <h1 className="text-4xl sm:text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-tight">
        ...
        <p className="text-gray-400 text-base md:text-xl max-w-3xl mx-auto font-medium mb-12 leading-relaxed">
          {t(
            "home.hero_desc",
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
          <button
            type="button"
            onClick={() => navigate("/register")}
            className="w-full sm:w-auto bg-white text-dark text-sm font-black uppercase tracking-widest px-8 md:px-10 py-5 md:py-6 rounded-2xl shadow-2xl hover:bg-gray-100 transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-3"
          >
          ...
          <button
            type="button"
            className="w-full sm:w-auto bg-dark/50 border border-gray-800 text-white text-sm font-black uppercase tracking-widest px-8 md:px-10 py-5 md:py-6 rounded-2xl hover:bg-gray-900 transition-all active:scale-95 cursor-pointer"
          >
      ...
      <section className="bg-secondary/30 py-16 md:py-32 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-dark/50 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-gray-800 hover:border-accent/40 transition-all shadow-2xl group relative overflow-hidden">
            ...
            <div className="bg-dark/50 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-gray-800 hover:border-blue-500/40 transition-all shadow-2xl group relative overflow-hidden">
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity hidden sm:block">
            ...
            <div className="bg-dark/50 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-gray-800 hover:border-green-500/40 transition-all shadow-2xl group relative overflow-hidden">
              <div className="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity hidden sm:block">
      ...
      <section className="py-16 md:py-32 bg-dark">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-8 bg-secondary/20 border border-gray-800/50 rounded-[2rem] md:rounded-[2.5rem] hover:bg-secondary/40 transition-all">
      ...
      <section className="py-16 md:py-32 bg-secondary/20 border-y border-gray-800/50 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-10">
            <div className="lg:col-span-2 bg-dark/80 p-8 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] border border-gray-800 shadow-2xl relative group">
            ...
            <div className="flex flex-col gap-6 md:gap-10">
              <div className="bg-accent/5 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-accent/20 flex-1 group hover:bg-accent/10 transition-all">
              ...
              <div className="bg-blue-500/5 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-blue-500/20 flex-1 group hover:bg-blue-500/10 transition-all">
      ...
      {/* Footer */}
      <footer className="py-16 md:py-20 bg-dark text-center border-t border-gray-800/50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8 mb-12">
            <button
              onClick={() => navigate("/login")}
              className="text-[10px] md:text-xs font-bold text-gray-500 hover:text-white uppercase tracking-widest transition-colors cursor-pointer"
            >
              {t("home.login")}
            </button>
            <button
            ...
            <button className="text-[10px] md:text-xs font-bold text-gray-500 hover:text-white uppercase tracking-widest transition-colors cursor-pointer text-center">
              Privacy Policy
            </button>
            <button className="text-[10px] md:text-xs font-bold text-gray-500 hover:text-white uppercase tracking-widest transition-colors cursor-pointer text-center">
              Terms of Service
          ...
          <p className="text-[8px] md:text-[9px] text-gray-600 font-medium tracking-[0.2em] sm:tracking-[0.3em] md:tracking-[0.5em] uppercase px-4 leading-relaxed">
